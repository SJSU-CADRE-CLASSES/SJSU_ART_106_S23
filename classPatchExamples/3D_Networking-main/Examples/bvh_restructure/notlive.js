...
function init() {
    ...
    // ws = new WebSocket('wss://gbhat.net/ws');
    // ws.onopen = function () {
    ...
    url = "https://raw.githubusercontent.com/CNMAT/3D_Networking/main/Examples/bvh_restructure/assets/example.bvh?token=GHSAT0AAAAAABRPXLWGWSZXJFV7JWDKBFM2YSUZJTA";
    ...
    const rootBone = rSkeleton.bones[0];
    mesh.add(rootBone);
